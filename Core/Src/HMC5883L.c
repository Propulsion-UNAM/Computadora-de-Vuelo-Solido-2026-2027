...
Vector HMC5883L_readRaw(void)
{
    ...
    v.ZAxis = HMC5883L_readRegister16(HMC5883L_REG_OUT_Z_M) - zOffset;
...
Vector HMC5883L_readNormalize(void)
{
    ...
    v.ZAxis = (float)HMC5883L_readRegister16(HMC5883L_REG_OUT_Z_M - zOffset) * mgPerDigit;

    return v;
}

void HMC5883L_setOffset(int xo, int yo,int zo)
{
    xOffset = xo;
    yOffset = yo;
    zOffset = zo;
